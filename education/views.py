...
def education_list(request):
    ...
    education_items = Education.objects.publicly_visible().order_by('-publish_date', '-created_at')
...
def education_detail(request, slug):
    ...
    qs = Education.objects.all() if preview else Education.objects.publicly_visible()
    if language_code == 'en':
